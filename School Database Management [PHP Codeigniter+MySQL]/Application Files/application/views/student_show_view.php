      ...
      <div class="card-body">
        <div class="form-validation">
          ...
          <form class="form-valide" action="<?php echo base_url(); ?>student/update_student" method="post">
              ...
              <div class="col-lg-6">
                ...
                <div class="form-group row">
                  <div class="col-lg-6">
                    ...
                    <input readonly type="text" class="form-control" id="contact" name="contact"
                    placeholder="Enter Contact Number"
                    value="<?php if($this->input->cookie('contact')){echo $this->input->cookie('contact');} else{echo $student[0]['contact'];} ?>">
                  </div>
                  <div class="col-lg-6">
                    <label>Alternate Contact</label>
                    <input readonly type="text" class="form-control" id="altcontact" name="altcontact"
              ...
              <div class="col-lg-6">
                ...
                <div class="form-group row">
                  <div class="col-lg-12">
                    ...
                    <input readonly type="text" class="form-control" id="landmark" name="landmark"
                ...
                <div class="form-group row">
                  <div class="col-lg-12">
                    ...
                    <textarea readonly class="form-control" rows="5" id="address" name="address" placeholder="Enter Address" style="height:100%;"><?php if($this->input->cookie('address')){echo $this->input->cookie('address');} else{echo $student[0]['address'];} ?></textarea>
                  </div>
                </div>
              </div>
              ...
              <div class="col-lg-6">
                ...
                <div class="form-group row">
                  <div class="col-lg-12">
                    ...
                    <input readonly type="text" class="form-control" id="aadhar" name="aadhar"
                ...
                <div class="form-group row">
                  <div class="col-lg-12">
                    <label>Comment</label>
                    <textarea readonly class="form-control" rows="5" id="comment" name="comment" placeholder="Enter Comment" style="height:100%;"><?php if($this->input->cookie('comment')){echo $this->input->cookie('comment');} else{echo $student[0]['comment'];} ?></textarea>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="form-group row">
              <div class="col-lg-8">
                <button type="button" id="close" class="btn btn-dark col-lg-2 offset-lg-8">Close</button>
              </div>
            </div>
