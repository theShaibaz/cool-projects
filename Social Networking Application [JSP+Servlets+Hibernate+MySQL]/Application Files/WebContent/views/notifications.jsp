                ...
                <div class="row">
		                        ...
		                        <%
									...
									if(notifications.size() > 0){
										...
										out.println("Your Notifications");
										out.println("<div class=\"float-right\">");
										out.println("<a href=\"/Mutiny-JSP-Hibernate/NotificationController?action=readNotifications\">");
										...
										for(Notification notification : notifications){
											...
											if(notificationType.equalsIgnoreCase("Friend Request")){
												...
												out.println("<a href=\"/Mutiny-JSP-Hibernate/NotificationController?action=readNotification&notificationId=" + notificationId + "&page=friendRequests\">");
											}
											else if(notificationType.equalsIgnoreCase("Request Accept")){
												
												out.println("<a href=\"/Mutiny-JSP-Hibernate/NotificationController?action=readNotification&notificationId=" + notificationId + "&page=userProfile&profileId="+ otherUserId +"\">");
											}
