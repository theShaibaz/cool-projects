...
<%@ page import="com.mutiny.models.UserProfile" %>
...
<body class="fix-header fix-sidebar" style="background-color: cadetblue;">
    ...
    <div id="main-wrapper">
       ...
       <%
       		...
       		int otherUserId = (int)session.getAttribute("otherUserId");
			List<PrivateMessage> privateMessages = UserDao.getPrivateMessages(userId, otherUserId);      	 
        ...
        <div class="container">
        	<div class="container-fluid">
                    ...
                    <div class="col-lg-10 offset-sm-1">
						<div class="card">
                            ...
                            <%
	        					...
	        					out.println("<a href=\"/Mutiny-JSP-Hibernate/UserController?action=showUserProfile&profileId=" + otherUserId + "\">");
								out.println("<img alt=\"...\" src=\"" + UserController.getProfilePicture(otherUserId) + "\" class=\"media-object\"></a>");
	        					out.println("</div>");
	        					out.println("<div class=\"media-body\">");
	        					out.println("<h4 class=\"media-heading\">" + UserDao.getUsername(otherUserId) + "</h4>");
	        					
	        					UserProfile profile = UserDao.getUser(otherUserId).getUserProfile();
	        					String isOnline = profile.getIsOnline();
	        					String lastLogin = HelperController.epochToDate(profile.getLastLogin());
	        					
	        					if(isOnline.equalsIgnoreCase("1")){
	        						out.println("<b><i class=\"fa fa-circle \" style=\"color:palegreen\" aria-hidden=\"true\"></i> Online</b>");
	        					}
	        					else{
	        						out.println("<b><i class=\"fa fa-circle\" aria-hidden=\"true\"></i> Last seen on " + lastLogin + "</b>");
	        					}
				...
				<%
                	...
                	out.println("<form action=\"/Mutiny-JSP-Hibernate/UserController?action=addPrivateMessage&otherUserId=" + otherUserId + "\" method=\"post\">");
				...
				<%
					...
					if(privateMessages.size() > 0){
						...
						for(PrivateMessage privateMessage : privateMessages){
							...
							int fromUserId = privateMessage.getFromUserId().getUserId();
							String messageText = privateMessage.getMessageContent();
							String date = HelperController.epochToDate(privateMessage.getMessagedOn());
