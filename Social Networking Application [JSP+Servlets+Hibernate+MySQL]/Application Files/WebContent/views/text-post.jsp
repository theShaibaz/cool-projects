                    ...
                    <div class="col-lg-10 offset-sm-1">
                        <div class="card">
                            ...
                            <%
                				...
                				out.println("<form action=\"/Mutiny-JSP-Hibernate/PostController?action=addPost&postType=text\" method=\"post\">");
                			...
                			%>
                            	...
                            	<div class="form-group">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-lg-6 offset-md-3">
                                            <textarea class="form-control" id="postContent" name="postContent" placeholder="Enter post" rows="50" style="height:90px;"></textarea>
                                        </div>
                                    </div>
