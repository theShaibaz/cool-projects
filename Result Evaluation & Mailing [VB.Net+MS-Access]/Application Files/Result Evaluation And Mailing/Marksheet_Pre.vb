...
Public Class Marksheet_Pre
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WindowsApplication1.Marksheet_Pre.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedMarksheet_Pre
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Marksheet_Pre = New Marksheet_Pre
        rpt.Site = Me.Site
        Return rpt
    End Function
