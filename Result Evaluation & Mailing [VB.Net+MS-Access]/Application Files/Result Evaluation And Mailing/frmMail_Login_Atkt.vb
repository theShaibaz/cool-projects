Public Class frmMail_Login_Atkt
    ...
    Private Sub frmMail_Login_Atkt_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        txtMailID.Clear()
        txtMailPass.Clear()
    End Sub
